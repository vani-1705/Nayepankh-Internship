...
const GROQ_API_KEY = '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';
...
async function sendMsg() {
  ...
  if (!GROQ_API_KEY) {
    input.value = '';
    appendMsg('user', text);
    appendMsg('ai', '⚠️ AI chat is not set up yet. Add your GROQ_API_KEY in config.js (see generate-config.js) to enable live replies. Meanwhile, you can reach us directly at contact@nayepankh.com or WhatsApp +91 8318500748 🙏');
    logActivity('Tried AI chat (no API key configured)');
    return;
  }
